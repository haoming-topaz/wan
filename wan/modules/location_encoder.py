...
'''
-1: Padding/No point (used to pad the input when needed, not an actual prompt)
0: Negative point (a user click indicating "not object" or background)
1: Positive point (a user click indicating "object" or foreground)
'''
